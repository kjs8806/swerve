...
const PARTS := [
	...
	{"id":"grip_tires", "name":"Grip Tires", "price":85, "rarity":"STANDARD", "ability":"grip_tires", "description":"Ignores oil patches entirely.", "icon_path":"res://assets/hud/parts/grip-tires.png"},
